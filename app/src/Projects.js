    ...
    return (
        <div data-bs-spy="scroll" data-bs-target="#list-example" data-bs-offset="0" className="scrollspy-example" tabIndex="0">
            ...
            <div className="row project-card pt-2 pb-2">
                <div onClick={()=> {window.location.replace("https://good-coders.gitlab.io/module3-project-gamma")}} className="col-4 d-flex pointer">
                ...
                <div className="col-8">
                    <div style={{height:"50px"}} className="d-flex align-items-center justify-content-between">
                       ...
                       <img className="pointer" onClick={()=> {window.location.replace("https://github.com/long-guan/green-beings")}} id="github-logo" style={{ width: "30px", height: "30px"}} src={github_mark_white} alt="page"/>
                    </div>
            ...
            <div className="row project-card pt-2 pb-2">
                ...
                <div className="col-8">
                    <div style={{height:"50px"}} className="d-flex align-items-center justify-content-between">
                       <h5 className="pointer" onClick={()=> {window.location.replace("https://good-coders.gitlab.io/module3-project-gamma")}}>Games From Long (Ago)</h5>
                       <img className="pointer" onClick={()=> {window.location.replace("https://github.com/long-guan/classic-games")}} id="github-logo" style={{ width: "30px", height: "30px"}} src={github_mark_white} alt="page"/>
                    </div>
                    <p className="pointer" onClick={()=> {window.location.replace("https://good-coders.gitlab.io/module3-project-gamma")}}>A web application built with vanilla HTML, CSS, and JS containing the games BattleShip and Tic Tac Toe.
                    </p>
                    <div className="d-flex" style={{gap: "5px"}}>
